...
public class Node_DLL 
{
	...
	public boolean write_process_header_for_XREF_hit(JTextArea_Solomon jta, boolean append_own_header_and_underline, Node_Process process)
	{
		try
		{
			...
			if(process != null && !process.I_HAVE_WRITTEN_PROCESS_HEADER_ALREADY)
				process.write_process_header_for_XREF_hit(jta);
			
			//hit found!
			if(jta != null && append_own_header_and_underline)
				jta.append(this.get_name() + "\n" + driver.UNDERLINE);
	...
	public boolean append_to_jta_XREF(String out, JTextArea_Solomon jta, boolean append_own_header_and_underline, Node_Process process)
	{
		try
		{
			...
			write_process_header_for_XREF_hit(jta, append_own_header_and_underline, process);
			
			if(append_own_header_and_underline)
				jta.append(out);
			else//doing this search on behalf of another entity e.g. process
				jta.append("[Module " + this.get_name() + "] - " + out);
	...
	public boolean search_XREF(String search_chars_from_user, String search_chars_from_user_lower, JTextArea_Solomon jta, boolean append_own_header_and_underline, Node_Process searching_proces)
	{
		try
		{
			...
			if(in_load != null && this.in_load.toLowerCase().trim().contains(search_chars_from_user_lower))
				this.append_to_jta_XREF("In_load: " + this.in_load, jta, append_own_header_and_underline, searching_proces);
						
			if(in_init != null && this.in_init.toLowerCase().trim().contains(search_chars_from_user_lower))
				this.append_to_jta_XREF("in_init: " + this.in_init, jta, append_own_header_and_underline, searching_proces);
			
			if(in_mem != null && this.in_mem.toLowerCase().trim().contains(search_chars_from_user_lower))
				this.append_to_jta_XREF("in_mem: " + this.in_mem, jta, append_own_header_and_underline, searching_proces);
			
			if(base != null && this.base.toLowerCase().trim().contains(search_chars_from_user_lower))
				this.append_to_jta_XREF("Base: " + this.base, jta, append_own_header_and_underline, searching_proces);
			
			if(size != null && this.size.toLowerCase().trim().contains(search_chars_from_user_lower))
				this.append_to_jta_XREF("Size: " + this.size, jta, append_own_header_and_underline, searching_proces);
			
			if(load_count != null && this.load_count.toLowerCase().trim().contains(search_chars_from_user_lower))
				this.append_to_jta_XREF("Load Count: " + this.load_count, jta, append_own_header_and_underline, searching_proces);
			
			if(path != null && this.path.toLowerCase().trim().contains(search_chars_from_user_lower))
				this.append_to_jta_XREF("Path: " + this.path, jta, append_own_header_and_underline, searching_proces);
					
			if(file_version != null && file_version.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("File Version: " + this.file_version, jta, append_own_header_and_underline, searching_proces);
			if(product_name != null && product_name.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Product Name: " + this.product_name, jta, append_own_header_and_underline, searching_proces);
			if(comments != null && comments.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Comments: " + this.comments, jta, append_own_header_and_underline, searching_proces);
			if(company_name != null && company_name.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Company Name: " + this.company_name, jta, append_own_header_and_underline, searching_proces);
			if(flags != null && flags.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Flags: " + this.flags, jta, append_own_header_and_underline, searching_proces);
			if(internal_name != null && internal_name.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Internal Name: " + this.internal_name, jta, append_own_header_and_underline, searching_proces);
			if(legal_trademarks != null && legal_trademarks.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Legal Trademarks: " + this.legal_trademarks, jta, append_own_header_and_underline, searching_proces);
			if(ole_self_register != null && ole_self_register.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("OLE Self Register: " + this.ole_self_register, jta, append_own_header_and_underline, searching_proces);
			if(os != null && os.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("OS: " + this.os, jta, append_own_header_and_underline, searching_proces);
			if(original_file_name != null && original_file_name.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Original File Name: " + this.original_file_name, jta, append_own_header_and_underline, searching_proces);
			if(copyright_legal_copyright != null && copyright_legal_copyright.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Legal Copyright: " + this.copyright_legal_copyright, jta, append_own_header_and_underline, searching_proces);
			if(file_description != null && file_description.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("File Description: " + this.file_description, jta, append_own_header_and_underline, searching_proces);
			if(file_type != null && file_type.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("File Type: " + this.file_type, jta, append_own_header_and_underline, searching_proces);
			if(product_version != null && product_version.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Product Version: " + this.product_version, jta, append_own_header_and_underline, searching_proces);
			if(file_size != null && file_size.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("File Size: " + this.file_size, jta, append_own_header_and_underline, searching_proces);
			if(date_modified != null && date_modified.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Date Modified: " + this.date_modified, jta, append_own_header_and_underline, searching_proces);
			if(language != null && language.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Language: " + this.language, jta, append_own_header_and_underline, searching_proces);
			...
			if(tree_base_address != null && tree_base_address.size() > 0)
			{
				...
				{
					if(base_addr != null && base_addr.toLowerCase().trim().contains(search_chars_from_user_lower)) this.append_to_jta_XREF("Base Address: " + base_addr, jta, append_own_header_and_underline, searching_proces);									
				}
			}
			...
			if(tree_api_hook != null)
			{
				for(Node_ApiHook node : this.tree_api_hook.values())
				{
					...
					node.search_XREF(search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "API Hook");
				}
			}
			...
			if(tree_import_function_table_dependencies != null)
			{
				for(Node_Import_DLL_Function node : this.tree_import_function_table_dependencies.values())
				{
					...
					node.search_XREF(search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "Dependencies");
				}
			}
			...
			if(tree_import_function_table_impscan != null)
			{
				for(Node_Import_DLL_Function node : this.tree_import_function_table_impscan.values())
				{
					...
					node.search_XREF(search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "Imp Scan");
				}
			}
			...
			//
			if(fle != null)
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle.getCanonicalPath(), "File", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "DLL");
			...
			if(this.fle_attributes != null)
			{
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.creation_date, "File Creation Date", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.extension, "File Extension", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.file_name, "File Name", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.hash_md5, "File Hash - MD5", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.hash_sha256, "File Hash - Sha256", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.last_accessed, "FileLast Accessed", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.last_modified, "File Last Modified", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
				XREF_SEARCH_HIT_FOUND |= this.check_value(fle_attributes.size, "File Size", search_chars_from_user, search_chars_from_user_lower, jta, searching_proces, "File Attributes");
			}
