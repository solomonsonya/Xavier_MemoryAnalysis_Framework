...
public class Node_DLL 
{
	...
	public volatile boolean XREF_SEARCH_HIT_FOUND = false, I_HAVE_WRITTEN_PROCESS_HEADER_ALREADY = false;
	...
	public boolean search_XREF(String search_string, String search_string_lower, JTextArea_Solomon jta, boolean append_own_header_and_underline, Node_Process process)
	{
		try
		{
			...
			if(in_load != null && this.in_load.toLowerCase().trim().contains(search_string_lower))
				this.append_to_jta_XREF("In_load: " + this.in_load, jta, append_own_header_and_underline, process);
						
			if(in_init != null && this.in_init.toLowerCase().trim().contains(search_string_lower))
				this.append_to_jta_XREF("in_init: " + this.in_init, jta, append_own_header_and_underline, process);
			
			if(in_mem != null && this.in_mem.toLowerCase().trim().contains(search_string_lower))
				this.append_to_jta_XREF("in_mem: " + this.in_mem, jta, append_own_header_and_underline, process);
			
			if(base != null && this.base.toLowerCase().trim().contains(search_string_lower))
				this.append_to_jta_XREF("Base: " + this.base, jta, append_own_header_and_underline, process);
			
			if(size != null && this.size.toLowerCase().trim().contains(search_string_lower))
				this.append_to_jta_XREF("Size: " + this.size, jta, append_own_header_and_underline, process);
			
			if(load_count != null && this.load_count.toLowerCase().trim().contains(search_string_lower))
				this.append_to_jta_XREF("Load Count: " + this.load_count, jta, append_own_header_and_underline, process);
			
			if(path != null && this.path.toLowerCase().trim().contains(search_string_lower))
				this.append_to_jta_XREF("Path: " + this.path, jta, append_own_header_and_underline, process);
					
			if(file_version != null && file_version.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("File Version: " + this.file_version, jta, append_own_header_and_underline, process);
			if(product_name != null && product_name.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Product Name: " + this.product_name, jta, append_own_header_and_underline, process);
			if(comments != null && comments.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Comments: " + this.comments, jta, append_own_header_and_underline, process);
			if(company_name != null && company_name.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Company Name: " + this.company_name, jta, append_own_header_and_underline, process);
			if(flags != null && flags.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Flags: " + this.flags, jta, append_own_header_and_underline, process);
			if(internal_name != null && internal_name.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Internal Name: " + this.internal_name, jta, append_own_header_and_underline, process);
			if(legal_trademarks != null && legal_trademarks.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Legal Trademarks: " + this.legal_trademarks, jta, append_own_header_and_underline, process);
			if(ole_self_register != null && ole_self_register.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("OLE Self Register: " + this.ole_self_register, jta, append_own_header_and_underline, process);
			if(os != null && os.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("OS: " + this.os, jta, append_own_header_and_underline, process);
			if(original_file_name != null && original_file_name.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Original File Name: " + this.original_file_name, jta, append_own_header_and_underline, process);
			if(copyright_legal_copyright != null && copyright_legal_copyright.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Legal Copyright: " + this.copyright_legal_copyright, jta, append_own_header_and_underline, process);
			if(file_description != null && file_description.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("File Description: " + this.file_description, jta, append_own_header_and_underline, process);
			if(file_type != null && file_type.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("File Type: " + this.file_type, jta, append_own_header_and_underline, process);
			if(product_version != null && product_version.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Product Version: " + this.product_version, jta, append_own_header_and_underline, process);
			if(file_size != null && file_size.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("File Size: " + this.file_size, jta, append_own_header_and_underline, process);
			if(date_modified != null && date_modified.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Date Modified: " + this.date_modified, jta, append_own_header_and_underline, process);
			if(language != null && language.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Language: " + this.language, jta, append_own_header_and_underline, process);
			...
			if(tree_base_address != null && tree_base_address.size() > 0)
			{
				...
				{
					if(base_addr != null && base_addr.toLowerCase().trim().contains(search_string_lower)) this.append_to_jta_XREF("Base Address: " + base_addr, jta, append_own_header_and_underline, process);									
				}
			}
