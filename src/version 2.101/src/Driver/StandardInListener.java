...
//				String command = "\"" + Start.fle_readPe.getCanonicalPath() + "\"";
//				//String params = " \"" + fle.getCanonicalPath();//leave last " off
//				String params = " " + line;
//				String execution_command = " " + line;
...
//				System.out.println("Executing: " + execution_command);
//				//
...
//			    catch(Exception e)
//			    {
//			    	driver.eop(myClassName, "process_read_pe - loop", e);
//			    }
