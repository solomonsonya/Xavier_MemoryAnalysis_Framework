...
public class Analysis_Report_Container_Writer extends Thread implements Runnable
{
	...
	public boolean commence_action()
	{
		try
		{
			...
			this.fle_analysis_report_html = new File(this.path_fle_analysis_directory + "html" + File.separator + "analysis_report_" + this.fle_memory_image.getName() + ".html");
...
/**change this --> */fle = dependency_file_writer_tables.write_dependency_files_VADTREE_table(import_file_name, page_title);						
	...
	public boolean write_analysis_report_footer(PrintWriter pwOut)
	{
		try
		{
			...
			pwOut.println("<p><br><br><br><hr><a href =\"https://github.com/solomonsonya/Xavier_MemoryAnalysis_Framework\"> Xavier Memory Analysis Framework vrs" + driver.VERSION + " </a></u> by Solomon Sonya @Carpenter1010 - " + driver.get_time_stamp() + "</p>");
