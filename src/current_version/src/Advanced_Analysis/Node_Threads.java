...
public volatile Node_Process process = null;
	...
	/**
	 * null constructor populated by import manifest file mtd
	 */
	public Node_Threads()
	{
		try
	...
	public boolean import_manifest_line_entry(String line_entry, String []arr, String key, String value, Advanced_Analysis_Director director)
	{
		try
		{
			...
			if(key.equals("TID")) TID = value;
			else if(key.equals("tid")) TID = value;
			else if(key.equals("ethread_address")) ethread_address  = value;
			else if(key.equals("PID") || key.equals("pid"))
			{
				pid = value;
				
				
				//at this point, TID, ehtread, and PID have been specified, retrieve the process
				try
				{
					//convert PId to int
					...
					//link this thread node to process
					if(ethread_address != null && !ethread_address.equals("") && process != null)
						process.tree_threads.put(ethread_address, this);
				}
				catch(Exception e)
				{
					driver.directive("\nError! I could not properly store thread id[" + TID + "] to process ID[" + pid + "]");
				}
			}
			...
			else if(key.equals("tags")) tags = value;
			else if(key.equals("created")) created = value;
			else if(key.equals("exited")) exited = value;
			else if(key.equals("owning_process_name")) owning_process_name = value;
			else if(key.equals("attached_process_name")) attached_process_name = value;
			else if(key.equals("state")) state = value;
			else if(key.equals("base_priority")) base_priority = value;
			else if(key.equals("priority")) priority = value;
			else if(key.equals("TEB")) TEB = value;
			else if(key.equals("teb")) TEB = value;
			else if(key.equals("start_address")) start_address = value;
			else if(key.equals("service_table_address")) service_table_address = value;
			else if(key.equals("service_table_0")) service_table_0 = value;
			else if(key.equals("service_table_1")) service_table_1 = value;
			else if(key.equals("service_table_2")) service_table_2 = value;
			else if(key.equals("service_table_3")) service_table_3 = value;
			else if(key.equals("win32thread")) win32thread = value;
			else if(key.equals("crossThreadFlags")) crossThreadFlags = value;
			else if(key.equals("eax")) eax = value;
			else if(key.equals("ebx")) ebx = value;
			else if(key.equals("ecx")) ecx = value;
			else if(key.equals("edx")) edx = value;
			else if(key.equals("esi")) esi = value;
			else if(key.equals("edi")) edi = value;
			else if(key.equals("eip")) eip = value;
			else if(key.equals("esp")) esp = value;
			else if(key.equals("ebp")) ebp = value;
			else if(key.equals("err")) err = value;
			else if(key.equals("cs")) cs = value;
			else if(key.equals("ss")) ss = value;
			else if(key.equals("ds")) ds = value;
			else if(key.equals("es")) es = value;
			else if(key.equals("gs")) gs = value;
			else if(key.equals("fs")) fs = value;
			else if(key.equals("efl")) efl = value;
			else if(key.equals("dr0")) dr0 = value;
			else if(key.equals("dr1")) dr1 = value;
			else if(key.equals("dr2")) dr2 = value;
			else if(key.equals("dr3")) dr3 = value;
			else if(key.equals("dr4")) dr4 = value;
			else if(key.equals("dr5")) dr5 = value;
			else if(key.equals("dr6")) dr6 = value;
			else if(key.equals("dr7")) dr7 = value;
			else if(key.equals("dr7")) dr7 = value;
