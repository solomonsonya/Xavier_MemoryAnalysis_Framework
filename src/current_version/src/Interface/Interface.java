...
public class Interface extends Thread implements Runnable, ActionListener, KeyListener
{
	...
	public static volatile JMenu jmnuHelp = null;
		...
		public static volatile JMenu jmnuEncryption = null;
			...
			public static volatile JMenuItem jmnuitm_Initiate_Advanced_Analysis = null;
	...
	public boolean initialize_component()
	{
		try
		{
			...
			jmnuAdvancedAnalysis = new JMenu("Advanced Analysis");
				...
				jmnuitm_Initiate_Advanced_Analysis = new JMenuItem("Initiate Advanced Analysis");	jmnuitm_Initiate_Advanced_Analysis.addActionListener(this);	jmnuitm_Initiate_Advanced_Analysis.setEnabled(false);  
				jmnuAdvancedAnalysis.add(jmnuitm_Initiate_Advanced_Analysis);
