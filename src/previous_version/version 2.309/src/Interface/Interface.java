	...
	public void run()
	{
		try
		{
			...
			{								
				...
				this.advanced_analysis_director = new Advanced_Analysis_Director(fle_volatility, fle_memory_image, PROFILE, path_fle_analysis_directory, file_attr_volatility, file_attr_memory_image, investigator_name, investigation_description, true, true);
			}
