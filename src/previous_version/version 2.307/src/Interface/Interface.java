	...
	public boolean initialize_component()
	{
		try
		{
			...
			jmnuAdvancedAnalysis = new JMenu("Advanced Analysis");
				...
				jmnuitm_Initiate_Advanced_Analysis_SingleFile.setToolTipText("Select this option to execute advanced analysis actions on the single memory image loaded");
