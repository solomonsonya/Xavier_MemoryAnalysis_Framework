...
public class Analysis_Report_Container_Writer extends Thread implements Runnable
{
	...
	public volatile String file_name_memory_image = "unspecified";
	...
	public Analysis_Report_Container_Writer(Advanced_Analysis_Director par)
	{
		try
		{
			...
			try
			{
				...
				file_name_memory_image = fle_memory_image.getName();
				
			}
			catch(Exception ee)
			{
				//if(parent.file_attr_memory_image != null)
				file_name_memory_image = "memory_image";
			}
			...
			try
			{
				system_information_tree_file_name = system_information_tree_file_name + "_" + file_name_memory_image + ".html";
			}
			catch(Exception e)
			{
				if(parent.file_attr_memory_image != null)
					system_information_tree_file_name = system_information_tree_file_name + "_" + file_attr_memory_image.file_name + ".html";
				else
					system_information_tree_file_name = system_information_tree_file_name + ".html";
			}
	...
	public boolean commence_action()
	{
		try
		{
			...
			{
				if(parent.file_attr_memory_image != null)
					this.fle_analysis_report_html = new File(this.path_fle_analysis_directory + "_html" + File.separator + "analysis_report_" + parent.file_attr_memory_image.file_name + ".html");
				else
					this.fle_analysis_report_html = new File(this.path_fle_analysis_directory + "_html" + File.separator + "analysis_report" + ".html");
			}
	...
	public boolean initialize_component()
	{
		try
		{
			...
			catch(Exception ee)
			{
				if(parent.file_attr_memory_image != null)
				{
					process_tree_file_name = "process_tree_" + parent.file_attr_memory_image.file_name + ".html";
					process_information_tree_file_name = "process_information_tree_" + parent.file_attr_memory_image.file_name + ".html";
				}
				else
				{
					process_tree_file_name = "process_tree" + ".html";
					process_information_tree_file_name = "process_information_tree" + ".html";
				}
	...
	public boolean write_button_graphs(PrintWriter pwOut)
	{
		try
		{
			...
			//GraphViz - Inner btn
			//
			if(parent.relative_path_to_converted_dot_process_image != null && !parent.relative_path_to_converted_dot_process_image.trim().equals(""))
			{
				pw.println("	<!--/////////////////////////////////////////////////////--> ");
				pw.println("		  	");
	...
	public boolean write_button_tables(PrintWriter pwOut)
	{
		try
		{
			if(parent.fle_memory_image == null && parent.fle_manifest_IMPORT == null)
			{
...
/**change this --> */fle = dependency_file_writer_tables.write_dependency_files_VADTREE_table(import_file_name, page_title);						
	...
	public boolean write_mft_table(String title, String file_name)
	{
		try
		{
			...
			///////////////////////////////////////////////////////////////////////////////			
				...
				String page_title = button_title + " Table - " + file_name_memory_image;						
				String import_file_name = button_title.trim().toLowerCase().replace(" ", "_") + "_table_" + file_name_memory_image + ".html";
	...
	public boolean write_analysis_report_header(PrintWriter pwOut)
	{
		try
		{
			...
			pw.println("		");
			pw.println("		");
			pw.println("	<title>Xavier Memory Analysis Report - " + file_name_memory_image + " </title>	");
			pw.println("		");
			pw.println("	<button type=\"button\" class=\"collapsible active\"><b>" + html_title + " - " + file_name_memory_image + " </b></button> <div class=\"content\" style=\"display: block; " + word_wrap_directive + " overflow: auto; width=auto; height=auto\">	");
			pw.println("	<p>	");
			...
			if(parent.PROFILE != null && parent.PROFILE.toLowerCase().trim().startsWith("win"))
			{
				...
				pw.println("	<tr> "
								...
								+ "<td> " + this.normalize_html(this.file_name_memory_image) + " </td>  "
						+ " </tr>	");
			...
			else
			{
				...
				pw.println("	<tr> <td> " + normalize_html(this.investigator_name) + " </td> <td> " + this.normalize_html(parent.EXECUTION_TIME_STAMP) + " </td> <td> " + this.normalize_html(this.investigation_description) + " </td> <td> " + this.normalize_html(this.file_name_memory_image) + " </td> <td> " + this.normalize_html(parent.PROFILE) + " </td> </tr>	");
			}
...
/**change this --> */			plugin_name = "pslist";
			...
			{				
				...
				page_title = button_title + " Plugin - " + file_name_memory_image;						
