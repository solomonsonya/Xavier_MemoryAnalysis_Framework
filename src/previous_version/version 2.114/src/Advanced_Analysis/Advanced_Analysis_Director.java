	...
	public boolean import_manifest(File fle)
	{
		...
		try
		{
			...
			{								
				...
				//process\tfile_attr
				//
				else if(lower.startsWith("process\tfile_attr"))						process_import_manifest_PROCESS(line, lower, "PROCESS", line_num, br, 0, true);
				...
				else if(lower.startsWith("session")) 								process_import_manifest_PROCESS(line, lower, "PROCESS", line_num, br, 0, true);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("netstat")) 			process_import_manifest_netstat(line, lower, "netstat", line_num, br, 7, false);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("handle")) 			process_import_manifest_handle(line, lower, "handle", line_num, br, 6, false);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("privilege")) 			process_import_manifest_privilege(line, lower, "privilege", line_num, br, 9, false);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("svcscan")) 			process_import_manifest_svcscan(line, lower, "svcscan", line_num, br, 7, false);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("gdi_timers")) 			process_import_manifest_gdi_timer(line, lower, "gdi_timers", line_num, br, 10, false);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("process deskscan")) 			process_import_manifest_PROCESS_deskscan_DEPRECATED(line, lower, "process deskscan", line_num, br, 16, true);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("envars")) 			process_import_manifest_envars(line, lower, "envars", line_num, br, 6, false);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("impscan")) 			process_import_manifest_impscan(line, lower, "impscan", line_num, br, 7, false);

				
				
				////////////////////////////////////////////////////////////
				//
				// child_process @Carpenter1010
				//
				//////////////////////////////////////////////////////////
				...
				////////////////////////////////////////////////////////////
				//
				// processes_linked_to_cmdline_cmdscan_consoles
				//
				//////////////////////////////////////////////////////////
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("user_assist")) 			process_import_manifest_user_assist(line, lower, "user_assist", line_num, br, 11, true);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("print_key")) 			process_import_manifest_print_key(line, lower, "print_key", line_num, br, 9, true);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("hivelist")) 			process_import_manifest_hivelist(line, lower, "hivelist", line_num, br, 8, false);
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("getservicesid")) 			process_import_manifest_getservicesid(line, lower, "getservicesid", line_num, br, 13, false);
			...
			if(list_import_manifest_file_error_message != null && list_import_manifest_file_error_message.size() > 0)
				driver.print_linked_list("\n\n*\nERROR! It looks like there were [" + list_import_manifest_file_error_message.size() + "] error(s) detected on this manifest import:", list_import_manifest_file_error_message);
			else
	...
	public boolean process_import_manifest_PROCESS(String line, String lower, String mtd_designator, Long line_num, BufferedReader br, int designator_len, boolean multi_lines_used_to_describe_single_node)
	{
		try
		{
			...
			if(multi_lines_used_to_describe_single_node) 
			{
				...
				//process file_attr
				//
				else if(key.equals("process file_attr")) 	
				{
					if(node_process_import_manifest.fle_attributes == null)
						node_process_import_manifest.fle_attributes = new FileAttributeData(arr, 1);
					else
						node_process_import_manifest.fle_attributes.import_data(arr, 1);
				}
				...
				else if(key.equals("session")) 				node_process_import_manifest.session  = value;
				...
				//other
				//
				else if(key.equals("found_in_pslist")) 		try	{	node_process_import_manifest.found_in_pslist  = Boolean.parseBoolean(value.trim());	} catch(Exception e){}
				else if(key.equals("found_in_psscan")) 		try	{	node_process_import_manifest.found_in_psscan  = Boolean.parseBoolean(value.trim());	} catch(Exception e){}
				else if(key.equals("relative_path_vadtree_image")) node_process_import_manifest.relative_path_vadtree_image  = value;
...
//			}
	 ...
	 * @return
	 */
	public boolean process_import_manifest_netstat(String line, String lower, String mtd_designator, Long line_num, BufferedReader br, int designator_len, boolean multi_lines_used_to_describe_single_node)
	{
		try
		{
			if(line == null || line.trim().equals("") || lower == null || lower.trim().equals(""))
	 ...
	 * @return
	 */
	public boolean process_import_manifest_cmdscan_consoles(String line, String lower, String mtd_designator, Long line_num, BufferedReader br, int designator_len, boolean multi_lines_used_to_describe_single_node)
	{
		try
		{
			if(line == null || line.trim().equals("") || lower == null || lower.trim().equals(""))
	 ...
	 * @return
	 */
	public boolean process_import_manifest_user_assist(String line, String lower, String mtd_designator, Long line_num, BufferedReader br, int designator_len, boolean multi_lines_used_to_describe_single_node)
	{
		try
		{
			if(line == null || line.trim().equals("") || lower == null || lower.trim().equals(""))
	 ...
	 * @return
	 */
	public boolean process_import_manifest_print_key(String line, String lower, String mtd_designator, Long line_num, BufferedReader br, int designator_len, boolean multi_lines_used_to_describe_single_node)
	{
		try
		{
			if(line == null || line.trim().equals("") || lower == null || lower.trim().equals(""))
...
//				this.write_manifest(WRITE_MANIFEST_DELIMITER);
	...
	public boolean print_file_attributes()
	{
		try
		{
			...
			File fle = new File(path_fle_analysis_directory + "file_attributes" + File.separator + "file_attributes_" + this.fle_memory_image.getName() + ".txt");
