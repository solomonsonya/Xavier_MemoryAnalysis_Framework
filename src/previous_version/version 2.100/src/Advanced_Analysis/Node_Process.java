	...
	public Node_Process(Advanced_Analysis_Director DIRECTOR, int pid, String PROCESS_NAME)
	{
		try
		{
			...
			if(director.PROCESS_IMPSCAN)
				impscan = new Analysis_Plugin_impscan(null, director, "impscan", "Scan for calls to imported functions", Analysis_Plugin_impscan.EXECUTE_VIA_THREAD, this);
		}
		catch(Exception e)
		{
...
//below - was working with dependencies import file, however I'll replace with impscan for simplicity and to deprecate dependency on Dependencies file
	...
	public boolean search_XREF(String search_string, String search_string_lower, JTextArea_Solomon jta)
	{
		try
		{
			...
			//tree_malfind
			//
			//solo, come back to add more, search through node's contents
