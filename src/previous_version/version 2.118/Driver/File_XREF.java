...
public class File_XREF extends Thread implements Runnable 
{
	...
	public volatile boolean I_HAVE_WRITTEN_HEADER = false;
		...
		try
		{
			...
			if(intrface.advanced_analysis_director == null) //and working directory path was not specified previously
			{
				...
				if(selection == 0)
				{
					...
					intrface.advanced_analysis_director = new Advanced_Analysis_Director(intrface.fle_volatility, intrface.fle_memory_image, intrface.PROFILE, intrface.path_fle_analysis_directory, intrface.file_attr_volatility, intrface.file_attr_memory_image, intrface.investigator_name, intrface.investigation_description, true, true);
				...
				{										
					...
					else //do not configure and rebuild trees, only search given directory of output files
					{
						...
						intrface.advanced_analysis_director = new Advanced_Analysis_Director(intrface.fle_volatility, intrface.fle_memory_image, intrface.PROFILE, intrface.path_fle_analysis_directory, intrface.file_attr_volatility, intrface.file_attr_memory_image, intrface.investigator_name, intrface.investigation_description, false, false);						
					}					
				...
				else if(selection == 2) //proceed here and execute respective plugins to enable XREF search
				{
					...
					intrface.advanced_analysis_director = new Advanced_Analysis_Director(intrface.fle_volatility, intrface.fle_memory_image, intrface.PROFILE, intrface.path_fle_analysis_directory, intrface.file_attr_volatility, intrface.file_attr_memory_image, intrface.investigator_name, intrface.investigation_description, false, true);
...
//					}
				...
				search_structure_PROCESS(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results);
				...
				//
				/////////////////////////////////////////////////////
				search_structure_DLL(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results);
				...
				//
				/////////////////////////////////////////////////////				
				search_structure_MODULE(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results);
						
		
				
				/////////////////////////////////////////////////////
				//
				// search tree_SERVICES_SVCSCAN
				//
				/////////////////////////////////////////////////////
				search_structure_SVCSCAN(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results);
				...
				//
				/////////////////////////////////////////////////////
				search_structure_TREE_STRING(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results, intrface.advanced_analysis_director.tree_hashdump, "Hashdump", true, true);
				
				search_structure_TREE_STRING(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results, intrface.advanced_analysis_director.tree_SIDS, "SIDS", true, true);
				
				search_structure_TREE_STRING_LINKED_LIST(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results, intrface.advanced_analysis_director.tree_session_entries, "Sessions", true, true);
				...
				//
				/////////////////////////////////////////////////////
				search_structure_NODE_GENERIC(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results, intrface.advanced_analysis_director.tree_DESKSCAN, "Deskscan", "Desktop");
				...
				//
				/////////////////////////////////////////////////////
				search_structure_Node_Registry_Hive(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results, intrface.advanced_analysis_director.tree_REGISTRY_HIVE_USER_ASSIST, "User Assist");
				search_structure_Node_Registry_Hive(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, intrface.jtaFile_XREF_Search_Results, intrface.advanced_analysis_director.tree_REGISTRY_HIVE_PRINTKEY, "User Assist");
	...
	public boolean search_svcscan_tree(TreeMap<String, Node_svcscan> tree, String structure_name, String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta)
	{
		try
		{
			...
			for(Node_svcscan node : tree.values())
			{
				...
				status |= node.search_XREF(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta, null, "Service Scan");								
			}						
		...
		{
			driver.eop(myClassName,  "search_svcscan_tree", e);
		}
	...
	/**
	 * continuation mtd from process_search - search tree structure of type <String, String>
	 * 
	 * @return
	 */
	public boolean search_structure_TREE_STRING(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta, TreeMap<String, String> tree, String container_name, boolean search_key, boolean search_value)
	{
		try
		{
			if(intrface.advanced_analysis_director == null || tree == null || tree.isEmpty() || jta == null)
				return false;
			
			boolean status = false;										
			
			boolean I_HAVE_WRITTEN_CONTAINER_HEADER = false;
			...
			if(search_key)
			{
				for(String key : tree.keySet())
				{
					...
					if(key.toLowerCase().contains(XREF_SEARCH_STRING_LOWER))
					{
						//
						//write header
						//
						if(!I_HAVE_WRITTEN_CONTAINER_HEADER)
						{
							jta.append("\n\n" + container_name + "\n" + driver.UNDERLINE);
							I_HAVE_WRITTEN_CONTAINER_HEADER = true;
							status = true;
						}
			...
			if(search_value)
			{
				for(String value : tree.values())
				{
					...
					if(value.toLowerCase().contains(XREF_SEARCH_STRING_LOWER))
					{
						//
						//write header
						//
		...
		{
			driver.eop(myClassName, "search_structure_TREE_STRING", e);
		}
	...
	public boolean search_structure_NODE_GENERIC(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta, TreeMap<String, Node_Generic> tree, String container_name, String mneumonic)
	{
		try
		{
			if(intrface.advanced_analysis_director == null || tree == null || tree.isEmpty())
				return false;
		...
		{
			driver.eop(myClassName, "search_structure_NODE_GENERIC", e);
		}
	 ...
	 * @return
	 */
	public boolean search_structure_SVCSCAN(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta)
	{
		try
		{
			if(intrface.advanced_analysis_director == null)
			...
			status |= this.search_svcscan_tree(intrface.advanced_analysis_director.tree_SERVICES_SVCSCAN, "Service Scan", XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta);
			...
			if(status)
			{
				...
				//reset tree's s.t. next searches will reset the nodes				
				reset_search_value_svcscan(intrface.advanced_analysis_director.tree_SERVICES_SVCSCAN, false);
		...
		{
			driver.eop(myClassName, "search_structure_SVCSCAN", e);
		}
	 ...
	 * @return
	 */
	public boolean search_structure_Node_Registry_Hive(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta, TreeMap<String, Node_Registry_Hive> tree, String container_name)
	{
		try
		{
			if(intrface.advanced_analysis_director == null || tree == null || tree.isEmpty())
			...
			reset_search_value_node_resistry_hive(tree, false);
			...
			for(Node_Registry_Hive hive : tree.values())
			{
				...
				status |= hive.search_XREF(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta, null, container_name);
			}			
		...
		{
			driver.eop(myClassName, "search_structure_Node_Registry_Hive", e);
		}
	 ...
	 * @return
	 */
	public boolean search_structure_TREE_STRING_LINKED_LIST(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta, TreeMap<String, LinkedList<String>> tree, String container_name, boolean search_key, boolean search_value)
	{
		try
		{
			if(intrface.advanced_analysis_director == null || tree == null || tree.isEmpty() || jta == null)
			...
			if(search_value)
			{
				for(LinkedList<String> list : tree.values())
				{
		...
		{
			driver.eop(myClassName, "search_structure_TREE_STRING_LINKED_LIST", e);
		}
	...
	/**
	 * continuation mtd from process_search to search Processes
	 * 
	 * @return
	 */
	public boolean search_structure_MODULE(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta)
	{
		try
		{
			if(intrface.advanced_analysis_director == null)
			...
			status |= this.search_driver_tree(intrface.advanced_analysis_director.tree_DRIVERS, "Drivers", XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta);
			status |= this.search_driver_tree(intrface.advanced_analysis_director.tree_DRIVER_IRP_HOOK, "Driver IRP Hook", XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta);
			status |= this.search_driver_tree(intrface.advanced_analysis_director.tree_CALLBACKS, "Callbacks", XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta);
			status |= this.search_driver_tree(intrface.advanced_analysis_director.tree_UNLOADED_MODULES, "Callbacks", XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta);
			status |= this.search_driver_tree(intrface.advanced_analysis_director.tree_TIMERS, "Timers", XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta);
			...
			if(status)
			{
				...
				//reset tree's s.t. next searches will reset the nodes				
				reset_search_value_driver(intrface.advanced_analysis_director.tree_DRIVERS, false);
				reset_search_value_driver(intrface.advanced_analysis_director.tree_DRIVER_IRP_HOOK, false);
				reset_search_value_driver(intrface.advanced_analysis_director.tree_CALLBACKS, false);
				reset_search_value_driver(intrface.advanced_analysis_director.tree_UNLOADED_MODULES, false);
				reset_search_value_driver(intrface.advanced_analysis_director.tree_TIMERS, false);
		...
		{
			driver.eop(myClassName, "search_structure_MODULE", e);
		}
	 ...
	 * @return
	 */
	public boolean search_structure_DLL(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta)
	{
		try
		{
			if(intrface.advanced_analysis_director == null)
			...
			//reset first since could have been set from Process search previously
			reset_search_value_dll(intrface.advanced_analysis_director.tree_DLL_by_path, false);
			
			status |= this.search_dll_tree(intrface.advanced_analysis_director.tree_DLL_by_path, "DLL", XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta);
		...
		{
			driver.eop(myClassName, "search_structure_DLL", e);
		}
		
		return false;
	}
	
	public boolean reset_search_value_driver(TreeMap<String, Node_Driver> tree, boolean search_flag)
	{
		try
		{
			if(tree == null || tree.isEmpty())
			...
			for(Node_Driver node : tree.values())
				node.I_HAVE_WRITTEN_PROCESS_HEADER_ALREADY = search_flag;
			
			return true;
		}
		catch(Exception e)
		{
			driver.eop(myClassName, "reset_search_value_driver", e);
		}
		
		return false;
	}
	
	public boolean reset_search_value_node_resistry_hive(TreeMap<String, Node_Registry_Hive> tree, boolean search_flag)
	{
		try
		{
			if(tree == null || tree.isEmpty())
			...
			for(Node_Registry_Hive node : tree.values())
			{
				node.I_HAVE_WRITTEN_PROCESS_HEADER_ALREADY = search_flag;				
			}
		...
		{
			driver.eop(myClassName, "reset_search_value_node_resistry_hive", e);
		}
		
		return false;
	}
	
	public boolean reset_search_value_svcscan(TreeMap<String, Node_svcscan> tree, boolean search_flag)
	{
		try
		{
			if(tree == null || tree.isEmpty())
	...
	public boolean reset_search_value_dll(TreeMap<String, Node_DLL> tree, boolean search_flag)
	{
		try
		{
			if(tree == null || tree.isEmpty())
		...
		{
			driver.eop(myClassName, "reset_search_value_dll", e);
		}
		
		return false;
	}
	
	public boolean reset_search_value_node_generic(TreeMap<String, Node_Generic> tree, boolean search_flag)
	{
		try
		{
			if(tree == null || tree.isEmpty())
		...
		{
			driver.eop(myClassName, "reset_search_value_node_generic", e);
		}
		
		return false;
	}
	
	public boolean search_dll_tree(TreeMap<String, Node_DLL> tree, String structure_name, String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta)
	{
		try
		{
			if(tree == null || tree.isEmpty())
			...
			for(Node_DLL node : tree.values())
			{
				...
				status |= node.search_XREF(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta, true, null, null, node, structure_name);								
			}						
		...
		{
			driver.eop(myClassName,  "search_dll_tree", e);
		}
		
		return false;
	}
	
	public boolean search_driver_tree(TreeMap<String, Node_Driver> tree, String structure_name, String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta)
	{
		try
		{
			if(tree == null || tree.isEmpty())
			...
			for(Node_Driver module : tree.values())
			{
				if(module == null)
					continue;
				
				status |= module.search_XREF(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta, null, module, structure_name);								
			}						
		...
		{
			driver.eop(myClassName,  "search_driver_tree", e);
		}
	 ...
	 * @return
	 */
	public boolean search_structure_PROCESS(String XREF_SEARCH_STRING, String XREF_SEARCH_STRING_LOWER, JTextArea_Solomon jta)
	{
		try
		{
			if(intrface.advanced_analysis_director == null)
			...
			for(Node_Process process : intrface.advanced_analysis_director.tree_PROCESS.values())
			{
				try
				{
					...
					if(process.search_XREF(XREF_SEARCH_STRING, XREF_SEARCH_STRING_LOWER, jta))
					{
						status = true;
		...
		{
			driver.eop(myClassName, "search_structure_PROCESS", e);
		}
