	...
	public boolean import_manifest(File fle)
	{
		...
		try
		{
			...
			{								
				...
				//
				//////////////////////////////////////////////////////////
				else if(lower.startsWith("cmdscan_consoles")) 			{ /*do nothing as cmdscan handles population of comd_scan consoles*/	}
...
if(false)
{
	...
	plugin_malfind = new Analysis_Plugin_malfind(null, this, "malfind", "Find hidden and injected code", false, jta);
